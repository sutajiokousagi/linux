 ...
 */
static int hw_wait_reg(struct ci_hdrc *ci, enum ci_hw_regs reg, u32 mask,
...
static void ci_handle_vbus_change(struct ci_hdrc *ci)
{
...
static bool ci_is_otg_capable(struct ci_hdrc *ci)
{
