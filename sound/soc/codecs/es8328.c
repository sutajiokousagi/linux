 ...
 * detect.
 */
static const struct reg_default es8328_reg_defaults[] = {
	{ 0, 0x1ff },
	{ 1, 0x1ff },
	{ 2, 0x001 },
	{ 3, 0x100 },
...
SOC_DOUBLE_R_TLV("Speaker Playback Volume",
		ES8328_DACCONTROL26, ES8328_DACCONTROL27, 0, 33, 0, play_tlv),
SOC_DOUBLE_R_TLV("HP Playback Volume",
		ES8328_DACCONTROL24, ES8328_DACCONTROL25, 0, 33, 0, play_tlv),
...
#define ES8328_RATES (SNDRV_PCM_RATE_8000_96000)
...
//	.reg_defaults = es8328_reg_defaults,
//	.num_reg_defaults = ARRAY_SIZE(es8328_reg_defaults),
